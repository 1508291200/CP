...
export function buildMilestoneRouter() {
  ...
  router.post('/', cpPermissionMiddleware('milestone:create'),
  ...
  router.patch('/:msId', cpPermissionMiddleware('milestone:edit'),
  ...
  router.delete('/:msId', cpPermissionMiddleware('milestone:delete'), async (c) => {
